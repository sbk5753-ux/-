...
| [`tools/youtube-shorts/`](tools/youtube-shorts) | 일본 랭킹형 쇼츠 대본 생성 → VOICEVOX 음성 → ffmpeg 영상 합성 |
...
cd ../youtube-shorts
cp .env.example .env
node generate-script.mjs "TOP5 랭킹 주제"
```
...
- [ ] VOICEVOX + ffmpeg 설치 후 `tools/youtube-shorts`로 쇼츠 1편 시험 제작
