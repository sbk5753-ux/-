...
블로그·인스타그램·유튜브 링크와 "온라인 스토어 오픈 예정" 신청 폼을 담은 정적 랜딩페이지입니다. 프레임워크 없이 순수 HTML/CSS/JS라 어디든 무료로 바로 배포할 수 있습니다.
...
## 채워야 할 부분
- `index.html`의 블로그/인스타/유튜브 링크가 실제 계정과 다르면 수정
...
## 다음 단계 (온라인 스토어로 확장할 때)
`docs/AUTOMATION-GUIDE.md`의 "4. 온라인 사업" 및 `docs/PRODUCT-IDEAS.md` 참고. 아이템이 정해지면 이 랜딩페이지는 브랜드 허브로 유지하고, 실제 상품 판매/결제는 스마트스토어 등으로 먼저 검증한 뒤, 이 저장소에 Next.js + 결제 모듈을 추가해 자체 스토어로 확장할 수 있습니다 (필요하시면 다음 작업으로 진행해 드립니다).
